#include "brainhl/G1Neuron.hpp"

namespace brainhl {

G1Neuron::G1Neuron(std::string id, double threshold, double tau_m)
    : NeuronBase(std::move(id), threshold), m_tau_m(tau_m) {}

void G1Neuron::updateState(double currentTime) {
    ...
    if (m_potential >= m_threshold) {
        ...
        // La propagación del impulso la gestionará la clase DynamicNetwork.
        ...
        // Resetear el potencial al de reposo (0.0 por defecto).
        m_potential = 0.0;
